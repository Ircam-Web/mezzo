...
class MezzoTestsRunner(DiscoverRunner):
	...
	def __init__(self, pattern=None, top_level=None, verbosity=1,
		...
		if kwargs['back']:
			pattern='tests.py'
		self.print_labels=kwargs['printlabels']
	...
	def run_tests(self, test_labels, extra_tests=None, **kwargs):
		if not test_labels:
			...
			test_labels+=('mezzanine_agenda','/srv/lib/mezzanine-agenda/')
	...
	def add_arguments(cls, parser):
		...
		parser.add_argument("--printlabels",help="Print all tests executed.",action="store_true")
